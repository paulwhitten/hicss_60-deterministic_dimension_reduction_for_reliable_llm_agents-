...
A preprint of this work presents the 2.5-D spatial construction method
and a compact benchmark evaluation. The present paper extends that
contribution by developing the deterministic-dimension reduction design
principle, adding edge-deployment and latency evidence, IGLU
cross-benchmark transfer, and design implications for reliable agentic
systems. Citation omitted for blind review.
