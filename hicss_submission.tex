...
Kimi-K2.5 about 84\%. These are preliminary results, and the
logs are in the public repository.
...
different numbers of tokens for the same input, especially reasoning
models. As one concrete instantiation, at
...
builds per unit cost, a comparison robust to cross-model token differences
