...
\parencite{held1991}, reduces the likelihood of $y$-coordinate errors.
...
structural constraints. We do not claim general applicability beyond what
these two benchmarks show. The boundary between deterministic and
reasoning dimensions is not always sharp, and in more complex tasks some
dimensions are only partly determined by task state, which is where the
principle needs further study. The taxonomy of three categories, geometric
