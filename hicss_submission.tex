...
3{,}365 of 6{,}349 single-turn tasks (53\%) whose targets contain no
...
95\% CI $[0.050, 0.101]$). The improvement persists on the stricter
additive-only subset that excludes removals, where F1 rises from 0.776 to
0.820 (paired $t(499) = 4.39$, $p < 0.001$). The effect size is small ($d = 0.26$),
