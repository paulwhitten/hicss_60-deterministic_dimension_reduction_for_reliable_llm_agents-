...
error accumulation showing that a symbolic executor strictly dominates
the language model on deterministic output dimensions for any positive
...
sequencing errors when delegated to the LLM.
...
All enrichment rules and prompt examples were developed against
GPT-4o-mini. The GPT-4o advantage may be understated, as the model
comparison measures architecture value with a tuned small model against
an untuned large model. The plan verifier null result ($p = 0.36$,
...
taxonomy of three categories, geometric constraints, procedural knowledge
constraints, and workflow state management constraints, provides a
structure for identifying decomposition opportunities in new domains.
The primary design lever is not model selection but responsibility
boundary placement.
