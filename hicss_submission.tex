...
improvement contribution \parencite{hevner2004}: reduce LLM errors on
...
BWIM and IGLU provide an artificial, summative evaluation.
...
Tegrastats measurements over all 12 runs show 71--75\,W mean board draw
in both conditions, dominated by the 108--119\,GB DRAM footprint of the
loaded model. Energy per round falls from 17.1\,kJ under full reasoning
to 6.1\,kJ under low-effort (2.8$\times$), tracking the latency
reduction rather than a change in power draw.
